...
const Modal = (props) => {
    return (
        <ReactModal
            ...
            className={`flex dark:bg-appColor-dark bg-appColor-light p-5 h-full w-full md:min-h-0 md:min-w-max ${props.className ? props.className : ""} self-center pt-9 md:pt-0 md:rounded-xl md:shadow-md overflow-y-scroll scrollDiv outline-none focus:outline-none`}
        >
