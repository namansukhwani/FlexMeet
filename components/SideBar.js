        ...
        <>
            <header className={` z-30 md:border-r bg-appColor-light dark:bg-appColor-dark border-gray-800 h-screen p-4 justify-between absolute md:relative flex flex-col ease-in-out duration-200 inset-y-0 transform transition ${props.isSidebarOpen ? "-translate-x-0" : "-translate-x-full"} md:-translate-x-0 shadow-sm md:shadow-none`}>
                ...
                <div className=" self-start">
                    <Link href="/me">
                        <div className={`relative mb-3 w-auto px-4 h-10 md:px-0 md:w-12 md:h-12 flex flex-row align-middle justify-start md:justify-center rounded-xl ${isActive('/me') ? "bg-gray-200 dark:bg-appColor-selectd" : "hover:bg-gray-200 dark:hover:bg-appColor-selectd"} `} onClick={() => props.closeSidebarMobile()}>
                    ...
                    <Link href="/me/messages">
                        <div className={`relative mb-3 w-auto px-4 h-10 md:px-0 md:w-12 md:h-12 flex flex-row align-middle justify-start md:justify-center rounded-xl ${isActive('/me/messages') ? "bg-gray-200 dark:bg-appColor-selectd" : "hover:bg-gray-200 dark:hover:bg-appColor-selectd"} `} onClick={() => props.closeSidebarMobile()}>
                    ...
                    <Link href="/me/recents">
                        <div className={`relative mb-3 w-auto px-4 h-10 md:px-0 md:w-12 md:h-12 flex flex-row align-middle justify-start md:justify-center rounded-xl ${isActive('/me/recents') ? "bg-gray-200 dark:bg-appColor-selectd" : "hover:bg-gray-200 dark:hover:bg-appColor-selectd"} `} onClick={() => props.closeSidebarMobile()}>
                    ...
                    <Link href="/me/contacts">
                        <div className={`relative mb-3 w-auto px-4 h-10 md:px-0 md:w-12 md:h-12 flex flex-row align-middle justify-start md:justify-center rounded-xl ${isActive('/me/contacts') ? "bg-gray-200 dark:bg-appColor-selectd" : "hover:bg-gray-200 dark:hover:bg-appColor-selectd"} `} onClick={() => props.closeSidebarMobile()}>
                ...
                <div className=" self-start">
                    <Link href="/me/settings">
                        <div className="w-12 h-12 flex align-middle justify-center rounded-xl bg-gray-200 dark:bg-appColor-selectd" onClick={() => props.closeSidebarMobile()}>
